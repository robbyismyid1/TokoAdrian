                ...
                <form action="{{ route('pembelian.store') }}" method="post">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="modal-footer form-group">
                            <button type="submit" class="btn btn-success" href="{{ route('pembelian.store') }}"><i
                ...
                <div class="col-md-12">
                    ...
                    <div id="pds" class="row text-center text-lg-left containerItems" style="position:relative;">
                        ...
                        <div class="col-md-2 col-md-offset-1" style="margin:0;">
                            ...
                            <div data-tooltip="tooltip" title="Update product"
                                data-toggle="modal" data-target="#updateModal{{ $produk->id }}"
                                data-name="{{ $produk->nama_produk }}" + data-id="{{ $produk->id }}" +
                                data-price="{{ $produk->harga_pembelian }}" + data-sale="{{ $produk->harga_penjualan }}"
                                class="btn btn-primary btn-sm" style="position: absolute; top: 0; right: 15px;z-index: 1;">
                                <i class="fas fa-edit"></i>
                            </div>
                            <div class="modal fade" id="updateModal{{ $produk->id }}" tabindex="-1" role="dialog" aria-labelledby="updateModal{{ $produk->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                      <div class="modal-header bg-success py-3">
                                        <span class="m-0 font-weight-bold text-white">{{ __('Ubah Produk') }} {{ $produk->nama_produk }}</span>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
                                      <div class="modal-body">
                                        <form action="{{ route('produk.updateprice', $produk->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-row">
                            ...
                            <a href="" id="product" data-tooltip="tooltip" title="Price : {{ $produk->harga_pembelian }} stock :
                ...
                success: function (data) {
                    var html = data.produks.map(function (item) {
                        ...
                        return `<div class="col-md-2 col-md-offset-1" style="margin:0;">
                            <div data-tooltip="tooltip" title="Update product"
                                data-toggle="modal" data-target="#updateModal${id}"
                                data-name="${name}" + data-id="${id}" +
                                data-price="${purchase}" + data-sale="${sale}"
                                class="btn btn-primary btn-sm" style="position: absolute; top: 0; right: 15px;z-index: 1;">
                                <i class="fas fa-edit"></i>
                            </div>
