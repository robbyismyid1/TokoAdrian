...
<head>
    ...
    <title>Tagihan | {{ $pembelian->nomor_pembelian }}</title>
...
<body>
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding: 0;">
                <div class="text-center too-border">
                    <h4>Tagihan : {{ $pembelian->nomor_pembelian }}</h4>
                </div>
                <div class="row">
                    <div class="col-md-6 col-print-6 text-center">
                        <div class="too-border">
                            <h4>Tanggal : <span style="font-size:15px">{{ $pembelian->created_at }}</span>
                            </h4>
                    ...
                    <div class="col-md-6 col-print-6 text-center">
                        ...
                        <div class="too-border">
                            Nama : {{ $pembelian_pemasok->nama_pemasok }}<br>Alamat : {{ $pembelian_pemasok->alamat }}
                            <br>Telepon : {{ $pembelian_pemasok->telepon }} <br>
                        </div>
                    </div>
                </div>
                <div class="table-responsive-sm">
                    <table class="table table-bordered" style="margin-bottom: 0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">Rp{{ number_format($pembelian_produk->harga_pembelian, 2, ',', '.') }}.
                                </td>
                                <td style="text-align:center;">{{ number_format($pembelian_produk->pivot->quantity, 0, '', '.') }}</td>
                                <td style="text-align:center;">
                                    Rp{{ number_format($pembelian_produk->pivot->quantity * $pembelian_produk->harga_pembelian, 2, ',', '.') }}.
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="float-right text-center" style="width:17.5%">
                        <div style=" border: 2px solid #000000;border-radius: 10px;margin: 5px 0;">
                            <p style="margin-bottom:0;"><strong>Rp{{ number_format($pembelian->total, 2, ',', '.') }}.</strong></p>
                        </div>
                        <div style=" border: 2px solid #000000;border-radius: 10px;margin: 5px 0;">
                            <p style="margin-bottom:0;"><strong>Rp{{ number_format($pembelian->diskon, 2, ',', '.') }}.</strong></p>
                        </div>
                        <div style=" border: 2px solid #000000;border-radius: 10px;margin: 5px 0;">
                            <p style="margin-bottom:0;"><strong>Rp{{ number_format($pembelian->jumlah_total, 2, ',', '.') }}.</strong></p>
                        </div>
                        <div style=" border: 2px solid #000000;border-radius: 10px;margin: 5px 0;">
                            <p style="margin-bottom:0;"><strong>Rp{{ number_format($pembelian->dibayar, 2, ',', '.') }}.</strong></p>
                        </div>
                        <div style=" border: 2px solid #000000;border-radius: 10px;margin: 5px 0;">
                            <p style="margin-bottom:0;">
                                <strong>Rp{{ number_format($pembelian->jumlah_total - $pembelian->dibayar, 2, ',', '.') }}.</strong></p>
                        </div>
                    </div>
    ...
    <div class="too-footer offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12 padding">
        <div class="too-border text-center">
            <p class="mb-0">{{ $activity }}. {{ $store_name }}. {{ $pembelian->created_at }}</p>
        </div>
    </div>
