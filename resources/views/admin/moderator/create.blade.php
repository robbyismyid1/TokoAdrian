@extends('layouts.main', ['activePage' => 'karyawan-create', 'titlePage' => __('Buat Karyawan')])
@section('title')
    {{ __('Buat Karyawan | TOKO ADRIAN') }}
@endsection
@section('page-head')
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header bg-success py-3">
            <h5 class="m-0 font-weight-bold text-white">{{ __('Buat Karyawan') }}
                <a href="{{ route('karyawan.index') }}" class="btn btn-sm btn-success float-right" style="">
            ...
            <form action="{{ route('karyawan.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>{{ __('Konfirmasi Kata Sandi') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="foto-img" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" type="file" placeholder="{{ __('') }}" value="{{ old('image') }}"/>
                        </div>
                        <div class="form-group">
                            <img id="foto-img-tag" src="{{ asset('uploads/moderator_images/default.png') }}" style="width:200px;"
                ...
                <div class="modal-footer form-group">
                    <button type="submit" class="btn btn-success" href="{{ route('karyawan.store') }}"><i
                            class="fas fa-user-plus"></i> {{ __('Buat Karyawan') }}</button>
                </div>
            </form>
