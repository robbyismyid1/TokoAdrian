                    ...
                    <div id="pds" class="row text-center text-lg-left containerItems">
                        ...
                        <div class="col-md-2 col-md-offset-1" style="margin:0;">
                            <a href="" data-tooltip="tooltip"
                                ...
                                data-placement="top" id="produk-{{ $produk->id }}" +
                ...
                success: function (data) {
                    var html = data.produks.map(function (item) {
                        ...
                        return `<div class="col-md-2 col-md-offset-1" style="margin:0;">
                            <a href="" data-tooltip="tooltip"
                                title="Price : ${sale} stock : ${stock}"
                                data-placement="top" id="produk-${id}" +
                                data-name="${name}" + data-id="${id}" +
                                data-price="${sale}" + data-stock="${stock}" class="con d-block mb-4 add-product-btn">
