$(document).ready(function () {
    ...
    $('.add-product-btn').on('click', function (e) {
        ...
        if (stock == 0) {
            ...
            Toast.fire({
                type: 'error',
                title: 'Stock produk sudah habis! tolong segera diperbarui!!'
            });
    ...
    $('body').on('keyup focus', '.paid', function () {
        ...
        var paid = $('#paid').val();
        if (paid == 0) {
            $('#select option[value="tidak dibayar"]').prop('selected', true);
        } else if (totalamount == paid) {
            $('#select option[value="dibayar"]').prop('selected', true);
        } else {
            $('#select option[value="hutang"]').prop('selected', true);
        }
